...
curl -sfL https://get.k3s.io | INSTALL_K3S_SKIP_START=true INSTALL_K3S_SKIP_SELINUX_RPM=true INSTALL_K3S_SYSTEMD_DIR=/usr/lib/systemd/system INSTALL_K3S_BIN_DIR=/usr/bin sudo sh -
